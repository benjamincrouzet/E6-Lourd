...
namespace E6_lourd
{
    public partial class Form3 : Form
    {
        ...
        private string connectionString = "server=localhost;database=bdd_cpx2;uid=root;pwd=;";
        ...
        public static class PasswordHelper
        {
            ...
            {
                // Utilise un cost de 10 comme PHP par défaut
            ...
            try
            {
                using (MySqlConnection conn = new MySqlConnection(connectionString))
                {
                    ...
                    foreach (var entry in textBoxes)
                    {
                        ...
                        {
                            string hashedPassword = PasswordHelper.HashPassword(entry.Value.Text);
                            updateFields.Add($"{entry.Key} = '{hashedPassword}'");
                        }
                        else
                        {
